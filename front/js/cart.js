...
const createCart = searchInLocalStorage.forEach((i) => {
  ...
  //Variable de validation de formulaire
...
//regex lastName, empeche les chiffres et les caractères spéciaux, sauf le "-"
const regexLastName = (e) => {
  //message d'erreur
  e.textContent =
    "Veillez à utiliser des caractères autorisé, le champs doit contenir entre 3 et 30 caractères ";
  e.style.display = "none";
...
//regex city, empeche les chiffres et les caractères spéciaux, sauf le "-"
const regexCity = (e) => {
  //message d'erreur
  e.textContent =
    "Veillez à utiliser des caractères autorisé, le champs doit contenir entre 3 et 30 caractères ";
...
firstName.addEventListener("input", (e) => {
  text = e.target.value;
  regexFirstName(firstNameErrorMsg);
});

//ecoute l'input nom
lastName.addEventListener("input", (e) => {
  text = e.target.value;
  regexLastName(lastNameErrorMsg);
});
...
const postRequest = order.addEventListener("click", () => {
  ...
  //condition de l"envoi de la commande
  if (inputFirstName === true && inputLastName === true && inputAddress === true && inputCity === true && inputEmail === true ) {
  ...
  //Fenetre d'erreur et rechaargement de la page
  alert("Echec de la commande, veuillez renseigner tous les champs correctement.")
